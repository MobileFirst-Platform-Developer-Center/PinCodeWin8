...
3. In the MobileFirst console, under **Applications** → **PinCodeWin8** → **Security** → **Map scope elements to security checks.**, add a mapping from `accessRestricted` to `PinCodeAttempts`.
